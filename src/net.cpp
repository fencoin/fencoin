...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FenCoin"+ FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1", "dnsseed1.zaobi.org"},
    {"seed2", "fnc.fencoin.net"},
    {"seed3", "fnc.fencoin1.com"},
    {"seed4",  "fnc.fencoin2.com"},
    {"seed5", "fnc.fencoin3.com"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. FenCoin is probably already running."), addrBind.ToString().c_str());
        else
