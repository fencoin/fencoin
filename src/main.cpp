...
int64 nChainStartTime = 1456907000;
...
const string strMessageMagic = "FenCoin signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight == 1)
	{
        nSubsidy = 270000000 * COIN;	// 1 billion coins, that all pow coins
        return nSubsidy + nFees;
//    }else if(nHeight<285714){
//        nSubsidy = 3.5 * COIN;
//        return nSubsidy + nFees;
//    }else if(nHeight<285714*2){
//        nSubsidy = 3.5/2 * COIN;
//        return nSubsidy + nFees;
//    }else if(nHeight<285714*3){
//        nSubsidy = 3.5/4 * COIN;
//        return nSubsidy + nFees;
//    }else if(nHeight<285714*4){
//        nSubsidy = 3.5/8 * COIN;
//        return nSubsidy + nFees;
//    }else if(nHeight<285714){
//        nSubsidy = 3.5/16 * COIN;
//        return nSubsidy + nFees;
    }
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    nRewardCoinYear = MAX_MINT_PROOF_OF_STAKE/2; //0.5%每年
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in FenCoin
    bool fStrictPayToScriptHash = true; // Always active in FenCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FenCoin",CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1456907896;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 13577693 ;
        ...
        assert(block.hashMerkleRoot == uint256("1215175243de75dbae2609a8e906b119c4302fadc530bd86c2c7d80c8efb2568"));
